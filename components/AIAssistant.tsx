    ...
    <div className="flex justify-start mb-3">
      <div className="max-w-[88%]">
        ...
        <div className="flex items-center gap-1.5 mb-1">
          ...
          <span className="text-[10px] text-zinc-500">ZecHub AI</span>
        </div>

        {/* Rendered markdown bubble */}
        <div className="rounded-2xl rounded-tl-none bg-zinc-800 px-4 py-3 text-sm text-zinc-100 leading-relaxed break-words prose-chat">
          <ReactMarkdown
            ...
            components={{
              ...
              h3: ({ children }) => (
                <h3 className="text-sm font-semibold text-[#F4B728] mt-2 mb-1 first:mt-0">{children}</h3>
              ),
              // Unordered lists
              ul: ({ children }) => (
    ...
    <>
      ...
      {isOpen && (
        <div
          ...
          className="fixed bottom-24 right-6 z-50 flex w-[380px] max-w-[calc(100vw-2rem)] flex-col overflow-hidden rounded-2xl border border-zinc-700 bg-zinc-900 shadow-2xl"
          style={{ height: "560px" }}
        >
          {/* Header */}
            ...
            {isLoading && (
              <div className="flex justify-start mb-3">
                <div className="flex flex-col gap-1">
                  <div className="flex items-center gap-1.5 mb-1">
                    <span className="flex h-5 w-5 items-center justify-center rounded-full bg-[#F4B728] text-black text-[9px] font-bold shrink-0">Z</span>
                    <span className="text-[10px] text-zinc-500">ZecHub AI is thinking…</span>
                  </div>
